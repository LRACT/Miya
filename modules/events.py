...
미야의 더욱 다양한 명령어는 `미야야 도움말` 명령어로 살펴보세요!
                ...
                embed.set_author(
                    name="반가워요!", icon_url=self.miya.user.avatar_url)
...
차단 시각 : {temp[0][3]}
                ...
                embed.set_author(
                    name="초대 제한", icon_url=self.miya.user.avatar_url)
